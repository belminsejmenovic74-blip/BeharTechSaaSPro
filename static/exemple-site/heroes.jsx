		...
		<div className="bmc">
			...
			>
				<div className="bmc-rise">
					...
					>
						Écran cassé, batterie, charge, caméra : passez directement à l'atelier. Diagnostic et
						devis gratuits, réparation possible dès 40 minutes selon la panne. Prix clairs, parmi
						les plus bas de la région.
					</p>
					<div style={{ display: 'flex', gap: 14, marginTop: 32 }}>
						<a className="bmc-btn bmc-btn--primary" href="#">
							Devis gratuit maintenant
						</a>
						<a className="bmc-btn bmc-btn--ghost" href="#/services">
				...
				<div style={{ position: 'relative' }}>
					<div
						...
						style={{
							position: 'absolute',
							inset: '-6% -4%',
							background: 'radial-gradient(60% 60% at 60% 40%, var(--steel-tint), transparent 70%)'
						}}
					/>
					<img
						src={BOARD}
						...
						style={{
							...
							width: '100%',
							display: 'block',
							filter: 'drop-shadow(0 30px 50px rgba(14,28,43,.18))'
						}}
					/>
			...
			<div style={{ padding: '48px 56px 58px' }}>
				...
				>
					<BAcell
						img={AVANT}
						label="AVANT"
						sub="iPhone 13 Pro — écran &amp; châssis détruits"
						tone="avant"
					/>
					<div
						style={{
					...
					<BAcell
						img={APRES}
						label="APRÈS"
						sub="Fonctionnel, étanchéité refaite, comme neuf"
						tone="apres"
					/>
				</div>
		...
		<div style={{ position: 'relative' }}>
			...
			<div
				style={{
					...
					alignItems: 'center',
					gap: 8,
					background: isApres ? 'var(--steel)' : 'rgba(14,28,43,.86)',
					color: '#fff',
			...
			<div
				style={{
					...
					background: 'linear-gradient(transparent,rgba(14,28,43,.78))',
					color: '#fff',
					fontSize: 13.5,
					fontWeight: 500
				}}
			...
			<div style={{ position: 'relative', padding: '56px 56px 0', overflow: 'hidden' }}>
				...
				<div
					style={{
						...
						inset: 0,
						backgroundImage:
							'linear-gradient(rgba(14,28,43,.045) 1px,transparent 1px),linear-gradient(90deg,rgba(14,28,43,.045) 1px,transparent 1px)',
						backgroundSize: '58px 58px',
						maskImage: 'radial-gradient(80% 80% at 70% 30%,#000,transparent)'
					}}
				/>
				<div
					style={{
				...
				>
					<div className="bmc-rise">
						...
						<h1 style={{ fontSize: 60, lineHeight: 1.0, fontWeight: 700, marginTop: 20 }}>
							...
							au niveau du
							<br />
							<span style={{ color: 'var(--steel)' }}>composant.</span>
						</h1>
						<p
							style={{
								fontSize: 17,
						...
						>
							Du quotidien au cas désespéré : écran, batterie, et la micro-soudure quand le
							remplacement ne suffit plus.
						</p>
						<div style={{ display: 'flex', gap: 14, marginTop: 30 }}>
							...
							<a
								className="bmc-btn bmc-btn--ghost"
								href="#/contact-pro"
								onClick={(e) => {
									e.preventDefault();
									BMCGo('#/contact-pro');
					...
					<div style={{ position: 'relative', alignSelf: 'end' }}>
						<img
							...
							style={{
								...
								marginRight: '-18%',
								display: 'block',
								filter: 'drop-shadow(0 30px 55px rgba(14,28,43,.20))'
							}}
						/>
