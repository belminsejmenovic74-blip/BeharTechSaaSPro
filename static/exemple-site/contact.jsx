	...
	if (!ready) {
		return (
			...
			>
				...
				<p style={{ color: 'var(--slate)', marginTop: 10, lineHeight: 1.6 }}>
					La démonstration sera disponible après la publication du widget.
				</p>
			</div>
		);
	}
	...
	return (
		<div className="bmc">
			...
			>
				...
				>
					Testez une demande comme votre client.
				</h1>
				<p
					style={{
						fontSize: 18,
				...
				>
					Ce parcours est relié à l’atelier Behar Tech. Les demandes de démonstration validées
					apparaissent dans le logiciel.
				</p>
			</section>
			<section
				id="widget-demo"
				style={{ padding: '46px 56px 76px', maxWidth: 980, margin: '0 auto' }}
			>
				<BeharWidgetFrame />
			</section>
			<Footer />
	...
	return (
		<div className="bmc">
			...
			<section style={{ background: 'var(--bg)', padding: '40px 20px 30px', textAlign: 'center' }}>
				<span className="bmc-eyebrow">Widget client</span>
				<h1 style={{ fontSize: 36, lineHeight: 1.05, marginTop: 12, fontWeight: 700 }}>
					Testez votre demande.
				</h1>
				<p style={{ fontSize: 15, color: 'var(--slate)', marginTop: 12, lineHeight: 1.6 }}>
					Une démonstration reliée au logiciel Behar Tech Pro.
				</p>
			</section>
			<section style={{ padding: '20px 14px 40px' }}>
				<BeharWidgetFrame mobile />
			</section>
			<MFooter />
		</div>
	);
