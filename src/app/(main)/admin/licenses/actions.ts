...
import { GenerateLicensesResult, LicenseKeyStatus } from "@/lib/supabase/license-types";
...
export async function generateLicenses(count: number = 50): Promise<GenerateLicensesResult> {
