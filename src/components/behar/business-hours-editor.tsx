  ...
  return (
    <div className="overflow-hidden rounded-[18px] border border-[#E4E7EC] bg-white">
      <div className="flex items-start gap-3 border-b border-[#EFEFEB] bg-[#FBFBF9] px-4 py-3.5">
        ...
        <div>
          <p className="text-sm font-semibold text-[#101828]">Horaires et pauses</p>
          ...
          return (
            <div
              ...
              className={cn(
                ...
                !day.enabled && "bg-[#FCFCFD]",
              )}
            >
              <label className="flex items-center gap-2.5 text-sm font-medium text-[#101828]">
                <input
                  type="checkbox"
              ...
              {day.enabled ? (
                <div className="grid gap-2 sm:grid-cols-[1fr_auto_1fr] sm:items-center">
                  ...
                  />
                  <span className="hidden items-center gap-1 text-[11px] font-medium text-[#98A2B3] sm:flex">
                ...
                <span className="text-sm text-[#98A2B3]">Fermé</span>
              )}
            </div>
          );
        })}
    ...
    <div className="grid grid-cols-[auto_1fr_auto_1fr] items-center gap-2">
      <button
        ...
        className={cn(
          ...
          value ? "border-[#9BD8CF] bg-[#E9F7F4] text-[#1E7A6E]" : "border-[#E4E7EC] bg-white text-[#98A2B3]",
        )}
      >
        {label}
      </button>
      ...
      />
      <span className="text-xs text-[#98A2B3]">à</span>
      <input
