...
import { FileText, FolderOpen, Plus, Receipt, Search, Wrench } from "lucide-react";
    ...
    <div className="space-y-5">
      ...
      <section className="grid gap-4 lg:grid-cols-4">
        <SummaryTile
          ...
          value={String(
            store.repairs.filter((repair) => repair.status !== "Prêt" && !isTerminalRepairStatus(repair.status)).length,
          )}
        />
