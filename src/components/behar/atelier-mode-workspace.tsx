...
export function AtelierModeWorkspace() {
  ...
  return (
    <div className="behar-app fixed inset-0 z-50 flex h-svh w-svw flex-col bg-white text-[#1A1916]">
      <header className="flex shrink-0 items-center justify-between gap-3 border-[#E8E8E5] border-b bg-white px-6 py-4 shadow-[0_1px_2px_rgba(26,25,22,0.035)] lg:px-10">
