...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  do {
    ...
    $$rendered = `${$$result.head += `<!-- HEAD_svelte-5v2kcn_START -->${$$result.title = `<title>Connexion | Behar Tech Pro</title>`, ""}<meta name="description" content="Connexion à Behar Tech Pro"><!-- HEAD_svelte-5v2kcn_END -->`, ""} <div class="container flex h-screen w-screen flex-col items-center justify-center">${validate_component(Button, "Button").$$render(
      $$result,
      {
        variant: "ghost",
        href: "/",
    ...
    })} <p class="px-8 text-center text-sm text-muted-foreground" data-svelte-h="svelte-48r894"><a href="/signup" class="hover:text-brand underline underline-offset-4">Pas encore de compte ? Inscrivez-vous</a></p></div></div>`;
  } while (!$$settled);
